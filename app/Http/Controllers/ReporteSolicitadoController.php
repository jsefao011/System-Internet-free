...
class ReporteSolicitadoController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            $mobj_data->Entidad = $this->EntidadRepo->flst_ContratoDocumentos($mint_entidadId, $mint_idContrato, $mint_estadoReporte,$mstr_FecReferencia);
            $mobj_data->Estado = $mint_estadoReporte;
            $mobj_data->Sel_idContrato = $mint_idContrato;
            $mobj_data->Text_FecRef = $mstr_FecReferencia;
            return view('modulos.consultarConsumo.solicitado.consumoSolicitado', ['item' => $item],['data' => $mobj_data]);
    }
