    ...
    public function index(Request $request)
    {
        ...
        $item = $this->f_castAccesos($user);
            ...
            if(is_int($mint_EntidadId) && $mint_EntidadId > 0 && is_int($mint_ContratoId) && $mint_ContratoId > 0)
            {
                ...
                $vobj_local->AreasSinAsig = $this->AreaRepo->flst_ListarAreaSinAsing($mint_EntidadId, $AreaId, $Niveles);
                ...
                return view('modulos.asignarAreasContrato.asignarAreaContrato', ['item' => $item],['vobj_local'=>$vobj_local]);
                //return $request->id
            }
            else
            {
