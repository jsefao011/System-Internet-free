                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="realtime">
                        <div id="grap_monitor" class="row">
                            <div class="col-md-5">
                                <select id="selec_contrato" class="selectpicker" data-live-search="true" data-style="btn btn-primary" title="Seleccionar Contrato" data-size="7">
                                    @if(isset($data->Contrato))
                                        @foreach($data->Contrato as $itemContrato)
                                            <option data-value="{{json_encode($itemContrato->areas)}}" data-mbps="{{$itemContrato->Velocidad_Mb}}" data-consumo="{{$itemContrato->ConsumoReal}}" value="{{$itemContrato->Interface}}">{{$itemContrato->Descripcion}}</option>
                                        @endforeach
                                    @endif
                                </select>
                            ...
                            <div class="" id="ConsumoReal" style="display: none">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#selec_contrato').change( function (d) {
                ...
                console.log(mlstAreas,mint_Mbps,mint_Consumo);
                f_graficoReloj(mint_Mbps,roundtwo(mint_Consumo));
                ...
                $('#Barraras').show(1000);
                $('#ConsumoReal').hide(1000);
                $('#ConsumoReal').removeClass("col-md-7");
            ...
            $('#selec_area').on('change',function () {
                ...
                $('#interface').val($(this).val());
                //$('#Barraras').hide(1000);
                $('#ConsumoReal').addClass("col-md-7");
                $('#ConsumoReal').show(1000);
                $('#grap_monitor').show(1000);
            ...
            function f_graficosbarra(Datos){
                $('#Barraras').highcharts({
                    ...
                    yAxis: {
                        min: 0,
                        title: {
                            text: 'Mbps/s Promedio Trimestral',
                            align: 'high'
                        },
                        labels: {
                            overflow: 'justify'
