            ...
            <div class="card card-pricing card-raised">
                <form name="formContrato" class="content" method="POST" role="form" action="<?php echo e(url('/pagContrato/asignarAreaContrato')); ?>">
                    <ul class="actions" style="margin:0;">
                        <li style="padding:0;">
                            <p class="category"><?php echo e($itemContrato->Descripcion); ?></p>
                        </li>
                        <li>
                            <ul class="actions" style="position: relative; top:-5px; right: -15px;margin:0;">
                                <li class="dropdown" style="padding: 0">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" style="margin:0;">
                                        ...
                                        <li style="padding: 2px;">
                                            <a class="btn-eliminar" data-id="<?php echo e($itemContrato->idCONTRATO); ?>"><i class="md md-delete"></i>&nbsp;Anular</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
        ...
        $(document).ready(function(){
           ...
           $('#btnCrearDetalle').on('click',function(){
            ...
            function f_Eliminar(vint_contratoId){
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo e(url("/pagContrato/Eliminar")); ?>',
