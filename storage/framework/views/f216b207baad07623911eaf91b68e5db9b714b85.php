            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Reporte -
                        <small><?php echo e($data->Entidad["Nombre"]); ?></small>
                    </h4>
                </div>
                <div class="card-content">
                    <button id="btnGenerar" style="float: right;" class="btn btn-primary btn-round">Genera Reporte</button>
                    <ul class="nav nav-pills nav-pills-warning">
                        <li <?php if($data->Estado == 1): ?>class="active" <?php endif; ?>>
                            <a href="<?php echo e(url('/pagConsumoSolicitado/EstadoDoc/1')); ?>">Generado</a>
                        </li>
                        <li <?php if($data->Estado == 2): ?>class="active" <?php endif; ?>>
                            <a href="<?php echo e(url('/pagConsumoSolicitado/EstadoDoc/2')); ?>">En Proceso</a>
                        </li>
                        <li <?php if($data->Estado == 3): ?>class="active" <?php endif; ?>>
                            <a href="<?php echo e(url('/pagConsumoSolicitado/EstadoDoc/3')); ?>">Validados</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active">
                            <div class="row">
                                <form name="formReporte" class="content" method="POST" role="form" action="<?php echo e(url('/pagConsumoSolicitado/Search')); ?>">
                                    <div class="col-sm-3">
                                        <select id="sel_contrato" name="sel_contrato" class="selectpicker" data-live-search="true" data-style="btn btn-primary" title="Selecionar Contrato">
                                            ...
                                            <?php foreach($data->Entidad["contrato"] as $itemContrato): ?>
                                                <option value="<?php echo e($itemContrato->idCONTRATO); ?>"><?php echo e($itemContrato->Descripcion); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group label-floating">
                                            ...
                                            <input  name ="text_fechaDesde" type="text" class="form-control datepickerRef" value="<?php echo e($data->Text_FecRef); ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <tbody>
                                        <?php foreach($data->Entidad->Documentos as $i => $itemDocumento): ?>
                                            <tr>
                                                <td width="3%"class="text-center"><?php echo e($i+1); ?></td>
                                                <td><?php echo e($itemDocumento->contrato["Descripcion"]); ?></td>
                                                <td class="text-center" style="font-size: 15px;"><?php echo e($itemDocumento->FechaRef); ?></td>
                                                <td class="text-center" style="font-size: 15px;"><?php echo e($itemDocumento->Cantidad); ?></td>
                                                ...
                                                <td colspan="4">
                                                    <div class="table-responsive">
                                                        <table class="table table-jse">
                                                            <tbody>
                                                            <?php foreach($itemDocumento->detalle as $j => $itemDetalle): ?>
                                                                <?php if($itemDetalle->EstadoDoc == 3): ?>
                                                                    <tr>
                                                                        <td class="text-center"><?php echo e($j+1); ?></td>
                                                                        <td>
                                                                            <ul style="list-style: none; display: inline-block;">
                                                                                <li><small>Creado el</small></li>
                                                                                <li><?php echo e(\Carbon\Carbon::parse($itemDetalle->Fecha)->format('d/m/Y h:i:s A')); ?></li>
                                                                                <li><small>por </small><?php echo e($itemDetalle->usuario["Usuario"]); ?></li>
                                                                            </ul>
                                                                            <ul style="list-style: none; display: inline-block;">
                                                                        ...
                                                                        <td>
                                                                            <ul class="actions">
                                                                                ...
                                                                                <?php if(count(explode('/',$itemDetalle->TypePrue))>1): ?>
                                                                                <li class="text-center"><a type="button" rel="tooltip" download="<?php echo e($itemDocumento->contrato["Descripcion"].'-Documento-Prueba.'.explode('/',$itemDetalle->TypePrue)[1]); ?>" href="<?php echo e('data:'.$itemDetalle->TypePrue.';base64,'.$itemDetalle->DocPrueba); ?>"><i class="md md-file-download md-lg"></i></a></li>
                                                                                <?php endif; ?>
                                                                            </ul>
                                                                        </td>
                                                                        <td class="td-actions text-right">
                                                                            <ul class="actions">
                                                                                <li>Simple :</li>
                                                                                <li class="text-center"><a class="btn-verDoc" data-tipo="2" data-iddocumento="<?php echo e($itemDetalle->idDocumentos); ?>"><i class="md md-visibility md-lg"></i></a></li>
                                                                                <a type="button" rel="tooltip" download="<?php echo e($itemDocumento->contrato["Descripcion"].'-'.$itemDetalle->Fecha.'.pdf'); ?>" href="<?php echo e('data:'.$itemDetalle->TypeDocum.';base64,'.$itemDetalle->DocumentoSimple); ?>"><i class="md md-file-download md-lg"></i></a>
                                                                            </ul>
                                                                        </td>
                                                                        <td class="td-actions text-right">
                                                                            <ul class="actions">
                                                                                <li>Detallado :</li>
                                                                                <li class="text-center"><a class="btn-verDoc" data-tipo="1" data-iddocumento="<?php echo e($itemDetalle->idDocumentos); ?>"><i class="md md-visibility md-lg"></i></a></li>
                                                                                <li class="text-center">
                                                                                    <a type="button" rel="tooltip" download="<?php echo e($itemDocumento->contrato["Descripcion"].'-'.$itemDetalle->Fecha.'.pdf'); ?>" href="<?php echo e('data:'.$itemDetalle->TypeDocum.';base64,'.$itemDetalle->Documento); ?>"><i class="md md-file-download md-lg"></i></a>
                                                                                </li>
                                                                            </ul>
                                                                        </td>
                                                                        <td width="3%" class="td-actions text-right">
                                                                            <ul class="actions">
                                                                                <li>
                                                                                    <a class="btn-restore" href="<?php echo e(url("/pagConsumoSolicitado/ExtornarDoc/".$itemDetalle->idDocumentos)); ?>"><i class="md md-settings-backup-restore md-lg"></i></a>
                                                                                </li>
                                                                            </ul>
                                                                        </td>
                                                                    </tr>
                                                                <?php elseif($itemDetalle->EstadoDoc == 2): ?>
                                                                    <tr>
                                                                        <td class="text-center"><?php echo e($j+1); ?></td>
                                                                        <td>
                                                                            <ul style="list-style: none; display: inline-block;">
                                                                        ...
                                                                        <td>
                                                                            <ul class="actions">
                                                                                <li>Prueba :</li>
                                                                                <li class="text-center">
                                                                                    <button style="padding: 6px;" class="btn btn-simple btn-behance btn-file" data-id="<?php echo e($itemDetalle->idDocumentos); ?>">
                                                                ...
                                                                <?php elseif($itemDetalle->EstadoDoc == 1): ?>
                                                                    <tr>
                                                                        <td class="text-center"><?php echo e($j+1); ?></td>
                                                                        <td>
                                                                            <ul style="list-style: none; display: inline-block;">
                                                                            ...
                                                                            <ul style="list-style: none; display: inline-block;">
                                                                                <li><small>Desde:</small> <?php echo e(\Carbon\Carbon::parse($itemDetalle->FechaDesde)->format('d/m/Y')); ?></li>
                                                                                <li><small>Hasta:</small> <?php echo e(\Carbon\Carbon::parse($itemDetalle->FechaHasta)->format('d/m/Y')); ?></li>
                                                                            </ul>
                                                                        </td>
                                                                        <td>
                                                                            <ul class="actions">
                                                                                <li>Validar: </li>
                                                                                <li class="text-center">
                                                                                    <a class="btn-AceptarDoc" href="<?php echo e(url("/pagConsumoSolicitado/AceptarDoc/".$itemDetalle->idDocumentos)); ?>">
                                                                        ...
                                                                        <td width="3%" class="td-actions text-right">
                                                                            <ul class="actions">
                                                                                <li>
                                                                                    <a href="<?php echo e(url("/pagConsumoSolicitado/EliminarDoc/".$itemDetalle->idDocumentos)); ?>" class="btn-delete"><i class="md md-delete md-lg"></i></a>
                                                                                </li>
                                                                            </ul>
                                                                        </td>
                                                                    </tr>
    ...
    <script>
        $(document).ready(function(){
            ...
            function f_actualizarSelContrato(){
                $('#sel_contrato').val(<?php echo e($data->Sel_idContrato); ?>);
            ...
            $('.btn-verDoc').on('click',function(){
                ...
                $('#ifr_reporte').html('');
                var html = '<iframe src="'+'<?php echo e(url("/pagConsumoSolicitado/VerGenerado")); ?>/'+mint_iddocumento + '/'+mint_tipo+'" height="600px" width="100%" frameborder="0" style="border: 0" allowfullscreen></iframe>';
