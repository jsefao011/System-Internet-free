                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            <div class="btn btn-round btn-fab bgm-white" style="position: absolute;top: -17px;min-width: 0;width: 55px;height: 55px;right: 130px;">
                                <button title="Cantidad Areas" id="Count_AreasSinAsing" class="btn btn-round btn-fab bgm-lightblue" style="height: 45px;width: 45px;min-width: 0;top: 5px;"><?php echo e((count($data->AreasSinAsig))); ?></button>
                            </div>
                        ...
                        <div class="card-header card-purple bgm-bluegray">
                            <div class="row">
                                <form class="col-xs-7"  name="formContrato" class="content" method="POST" role="form" action="<?php echo e(url('/pagContrato/asignarAreaContrato')); ?>">
                                    ...
                                    <button title="Ver Reporte Detallado" data-idcontrato="<?php echo e($itemContrato->idCONTRATO); ?>" type="button" class="btn btn-round btn-fab bgm-teal btn-reporte" style="position: absolute; height: 52px;width: 52px;min-width: 0;top: 5px;top: -15px;right: 70px;"><i class="md md-content-paste md-lg"></i></button>
                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                    <input type="hidden" name="_contratoid" value="<?php echo e($itemContrato->idCONTRATO); ?>">
                                </form>
                                <div class="col-xs-5">
                                    <div class="btn btn-round btn-fab bgm-white" style="position: absolute;top: -17px;min-width: 0;width: 55px;height: 55px;right: 130px;">
                                        <button title="Cantidad de Areas" class="btn btn-round btn-fab bgm-lightblue" style="height: 45px;width: 45px;min-width: 0;top: 5px;"><?php echo e(count($itemContrato->areas)); ?></button>
                                    </div>
                                    <div class="btn btn-round btn-fab bgm-white" style="position: absolute;top: -17px;min-width: 0;width: 55px;height: 55px;right: 200px;">
                                        <button title="Cantidad de Mbps" class="btn btn-round btn-fab bgm-indigo" style="height: 45px;width: 45px;min-width: 0;top: 5px;"><?php echo e($itemContrato->Velocidad_Mb); ?></button>
                                    </div>
