...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-xs-12">
            <ul class="actions" style="float: right;"><li><a class="bgm-purple" style="border-radius: 50%;"></a></li><li><h5 class="card-title"><small></small>Mbps</h5></li><li><a class="bgm-pink" style="margin-left: 10px; border-radius: 50%;"></a></li><li><h5 class="card-title"><small></small>Areas</h5></li></ul>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
                ...
                <div class="card-header card-purple bgm-pink">
                    <div class="row">
                        ...
                        <div class="col-xs-5">
                            ...
                            <button class="btn btn-round btn-fab bgm-pink btn-CrearArea btn-Principal" style="position: absolute; height: 45px;width: 45px;min-width: 0;top: 5px;top: -15px;right: 70px;"><i class="md md-add md-lg"></i></button>
                            ...
                            <?php foreach($data->AreasSinAsig  as $i => $itemArea): ?>
                                <tr data-id="<?php echo e($itemArea->idAREA); ?>">
                                 <?php if(count($itemArea->area)> 0): ?>
                                    <td class="card-link btn-colapcin no-seleccionable"><i class="ico-colapcin md md-keyboard-arrow-up md-lg" style="display:inline-block;font-size: 2em;vertical-align: -50%;"><div class="tblcount" style="display: inline-block;"><?php echo e($i+1); ?></div></i></td>
                                 <?php else: ?>
                                    <td><i class="md md-lg" style="font-size: 2em;vertical-align: -50%;"><div class="tblcount"><?php echo e($i+1); ?></div></i></td>
                                 <?php endif; ?>
                                    <td><?php echo e($itemArea->Nom_Area); ?></td>
                                     <td><?php echo e($itemArea->dispositivo["Nombre"]); ?></td>
                                    <td><?php echo e($itemArea->Interface); ?></td>
                                     <td><?php echo e($itemArea->CTAS_CTR); ?></td>
                                    <td>
                                        <ul class="actions">
                                            <li>
                                ...
                                <tr class="colapcin table-colapcin panel" data-codpadre="<?php echo e($itemArea->idAREA); ?>">
                                    ...
                                    <?php foreach($itemArea->area as $i => $itemArea): ?>
                                        ...
                                        <?php if(count($itemArea->area)> 0): ?>
                                                            <td class="card-link btn-colapcin no-seleccionable"><i class="ico-colapcin md md-keyboard-arrow-up md-lg" style="display:inline-block;font-size: 2em;vertical-align: -50%;"><div class="tblcount" style="display: inline-block;"><?php echo e($i+1); ?></div></i></td>
                                        <?php else: ?>
                                                            <td><i class="md md-lg" style="display:inline-block;font-size: 2em;vertical-align: -50%;"><div class="tblcount" style="display:inline-block;"><?php echo e($i+1); ?></div></i></td>
                                        <?php endif; ?>
                                                            <td><?php echo e($itemArea->Nom_Area); ?></td>
                                                            <td><?php echo e($itemArea->dispositivo["Nombre"]); ?></td>
                                                            <td><?php echo e($itemArea->Interface); ?></td>
                ...
                <div class="col-sm-12">
                    <div class="card-jse card-contrato">
                        <div class="card-header card-purple bgm-purple">
                            <div class="row">
                                <form class="col-xs-7"  name="formContrato" class="content" method="POST" role="form" action="<?php echo e(url('/pagContrato/asignarAreaContrato')); ?>">
                                    <h2 style="display: inline-block"><?php echo e($itemContrato->Descripcion); ?></h2>
                                    <button type="submit" class="btn btn-round btn-fab bgm-pink" style="position: absolute; height: 52px;width: 52px;min-width: 0;top: 5px;top: -15px;right: 140px;"><i class="md md-domain md-lg"></i></button>
                                    <button data-idcontrato="<?php echo e($itemContrato->idCONTRATO); ?>" type="button" class="btn btn-round btn-fab bgm-pink btn-reporte" style="position: absolute; height: 52px;width: 52px;min-width: 0;top: 5px;top: -15px;right: 70px;"><i class="md md-content-paste md-lg"></i></button>
                                    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                                    <input type="hidden" name="_contratoid" value="<?php echo e($itemContrato->idCONTRATO); ?>">
                                </form>
                                <div class="col-xs-5">
                                    <div class="btn btn-round btn-fab bgm-white" style="position: absolute;top: -17px;min-width: 0;width: 55px;height: 55px;right: 130px;">
                        ...
                        <div class="card-body card-padding panel-group colapcin card-colapcin">
                            <div class="table-responsive">
                                <table data-id="<?php echo e($itemContrato->idCONTRATO); ?>" data-importe="<?php echo e($itemContrato->Importe); ?>" data-mbts="<?php echo e($itemContrato->Velocidad_Mb); ?>" data-nivel = "1" class="table table-hover table-jse">
                                    ...
                                    <th width="20%">% Mbps Asignados</th>
                                    <th width="18%" class="text-center">Mbps Asignados</th>
                                    <th width="20%">Sub Total</th>
                                    <th width="2%"></th>
                                    </thead>
                                    <tbody>
                                    <?php foreach($itemContrato->areas  as $i => $itemArea1): ?>
                                             <tr data-id="<?php echo e($itemArea1->idAREA); ?>" data-nivel="1">
                                        ...
                                        <?php else: ?>
                                                <td><i class="md md-lg" style="font-size: 2em;vertical-align: -50%;"><?php echo e($i+1); ?></i></td>
                                                 <?php endif; ?>
                                            <td><?php echo e($itemArea1->Nom_Area); ?></td>
                                            <td><?php echo e($itemArea1->Interface); ?></td>
                                            <td style="text-align: center;"><div class="td-total" style="display: inline-block;"><?php echo e($itemArea1->ConsumoReal); ?>&nbsp;Mpbs</div></td>
                                            <td class="porc_mbts" style="padding: 0;">
                                                <div class="form-group label-floating" style="padding: 0;margin: 0;display: inline-block;width: 80%;">
                                                    <input value="<?php echo e($itemArea1->consumo["Porc_Mbps"]); ?>" type="number" min="0" max="100" step="0.01" class="form-control" style="text-align: center; margin-bottom: 5px;">
                                                </div>
                                                <div style="display: inline-block;width: 10%;">%</div>
                                            </td>
                                            <td class="text-center"><div class="cant_mbts" style="display: inline-block;"><?php echo e($itemArea1->consumo["Mbps_Asignado"]); ?></div>&nbsp;Mpbs</td>
                                            <td class="">S/.<div class="subtotal" style="display: inline-block;"><?php echo e($itemArea1->consumo["SubTotal"]); ?></div></td>
                                            <td class="card-link"><!--<i class="md md-add md-lg btn-ModalSubArea" style="font-size: 2em;vertical-align: -50%;"></i>--></td>
                                             </tr>
                                        <?php if(count($itemArea1->area)> 0): ?>
                                             <tr class="colapcin table-colapcin panel" data-codpadre="<?php echo e($itemArea1->idAREA); ?>">
                                                 <td></td>
                                                 <td colspan="7">
                                                     <div class="table-responsive">
                                                         <table class="table table-hover table-jse" data-importe="<?php echo e($itemArea1->consumo["SubTotal"]); ?>" data-mbts="<?php echo e($itemArea1->consumo["Mbps_Asignado"]); ?>" data-nivel = "2">
                                                             <thead class="bgm-pink">
                                                             <th width="5%">#</th>
                                                             <th width="25%"><?php echo e($itemArea1->Nom_Area); ?></th>
                                                             <th width="20%">% Mbps Asignados</th>
                                                             ...
                                                             <tbody>
                                            <?php foreach($itemArea1->area as $i => $itemArea2): ?>
                                                                     <tr data-id="<?php echo e($itemArea2->idAREA); ?>" data-nivel="2">
                                                <?php if(count($itemArea2->area)> 0): ?>
                                                                             <td class="card-link btn-colapcin no-seleccionable"><i class="ico-colapcin md md-keyboard-arrow-up md-lg" style="font-size: 2em;vertical-align: -50%;"><?php echo e($i+1); ?></i></td>
                                                <?php else: ?>
                                                                             <td><i class="md md-lg" style="font-size: 2em;vertical-align: -50%;"><?php echo e($i+1); ?></i></td>
                                                <?php endif; ?>
                                                                         <td><?php echo e($itemArea2->Nom_Area); ?></td>
                                                                        <td class="porc_mbts" style="padding: 0;">
                                                                            <div class="form-group label-floating" style="padding: 0;margin: 0;display: inline-block;width: 80%;">
                                                                                <input value="<?php echo e($itemArea2->consumo["Porc_Mbps"]); ?>" type="number" min="0" max="100" step="0.01" class="form-control" style="text-align: center; margin-bottom: 5px;">
                                                                            </div>
                                                                            <div style="display: inline-block;width: 10%;">%</div>
                                                                        </td>
                                                                        <td class="text-center"><div class="cant_mbts" style="display: inline-block;"><?php echo e($itemArea2->consumo["Mbps_Asignado"]); ?></div>&nbsp;Mpbs</td>
                                                                        <td class="">S/.<div class="subtotal" style="display: inline-block;"><?php echo e($itemArea2->consumo["SubTotal"]); ?></div></td>
                                                                         <td class="card-link"><!--<i class="md md-add md-lg btn-ModalSubArea" style="font-size: 2em;vertical-align: -50%;"></i>--></td>
                                                                     </tr>
                                                <?php if(count($itemArea2->area)> 0): ?>
                                                                     <tr class="colapcin table-colapcin panel" data-codpadre="<?php echo e($itemArea2->idAREA); ?>">
                                                                         <td></td>
                                                                         <td colspan="6">
                                                                             <div class="table-responsive">
                                                                                 <table class="table table-hover table-jse"  data-importe="<?php echo e($itemArea2->consumo["SubTotal"]); ?>" data-mbts="<?php echo e($itemArea2->consumo["Mbps_Asignado"]); ?>" data-nivel = "3">
                                                                                     <thead class="bgm-orange">
                                                                                     <th width="5%">#</th>
                                                                                     <th width="25%"><?php echo e($itemArea2->Nom_Area); ?></th>
                                                                                     <th width="20%">% Mbps Asignados</th>
                                                                                     <th width="23%" class="text-center">Mbps Asignados</th>
                                                                                     <th width="25%">Sub Total</th>
                                                                                     <th width="2%"></th>
                                                                                     ...
                                                                                     <tbody>
                                                    <?php foreach($itemArea2->area as $i => $itemArea3): ?>
                                                                                        <tr data-id="<?php echo e($itemArea3->idAREA); ?>" data-nivel="3">
                                                                                            <td><i class="md md-lg" style="font-size: 2em;vertical-align: -50%;"><?php echo e($i+1); ?></i></td>
                                                                                            <td><?php echo e($itemArea3->Nom_Area); ?></td>
                                                                                            <td class="porc_mbts" style="padding: 0;">
                                                                                                <div class="form-group label-floating" style="padding: 0;margin: 0;display: inline-block;width: 80%;">
                                                                                                    <input value="<?php echo e($itemArea3->consumo["Porc_Mbps"]); ?>" type="number" min="0" max="100" step="0.01" class="form-control" style="text-align: center; margin-bottom: 5px;">
                                                                                                </div>
                                                                                                <div style="display: inline-block;width: 10%;">%</div>
                                                                                            </td>
                                                                                            <td class="text-center"><div class="cant_mbts" style="display: inline-block;"><?php echo e($itemArea3->consumo["Mbps_Asignado"]); ?></div>&nbsp;Mpbs</td>
                                                                                            <td class="">S/.<div class="subtotal" style="display: inline-block;"><?php echo e($itemArea3->consumo["SubTotal"]); ?></div></td>
                                                                                            <td class="card-link"><!--<i class="md md-add md-lg btn-ModalSubArea" style="font-size: 2em;vertical-align: -50%;"></i>--></td>
                                                    ...
                                                    <?php endforeach; ?>
                                                                                         ...
                                                                                         <tr >
                                                                                             ...
                                                                                             <td class="text-center"><div class="totalPorc_Mbps" style="display: inline-block;"><?php echo e($itemArea2->totalPorcMbps); ?></div>%</td>
                                                                                             <td class="text-center"><div class="totalCant_Mbps" style="display: inline-block;"><?php echo e($itemArea2->totalCantMbps); ?></div>&nbsp;Mbps</td>
                                                                                             <td class="text-left">S/.<div class="totalimporte_Mbps" style="display: inline-block;"><?php echo e($itemArea2->totalImporMbts); ?></div></td>
                                                                                             <td colspan="2"></td>
                                                                                         </tr>
                                                                                         </tfoot>
                                                                                     </table>
                                            ...
                                            <?php endforeach; ?>
                                                             ...
                                                             <tfoot class="" >
                                                                 <tr >
                                                                     <td></td>
                                                                     <td class="td-total text-center">Total</td>
                                                                     <td class="text-center"><div class="totalPorc_Mbps" style="display: inline-block;"><?php echo e($itemArea1->totalPorcMbts); ?></div>%</td>
                                                                     <td class="text-center"><div class="totalCant_Mbps" style="display: inline-block;"><?php echo e($itemArea1->totalCantMbts); ?></div>&nbsp;Mbps</td>
                                                                     <td class="text-left">S/.<div class="totalimporte_Mbps" style="display: inline-block;"><?php echo e($itemArea1->totalImporMbts); ?></div></td>
                                                                     <td colspan="2"></td>
                                                                 </tr>
                                                                 </tfoot>
                                                             </table>
                                    ...
                                    <tr >
                                        ...
                                        <td></td>
                                        <td class="td-total text-center">Total</td>
                                        <td class="text-center"><div class="totalPorc_Mbps" style="display: inline-block;"><?php echo e($itemContrato->totalPorcMbts); ?></div>%</td>
                                        <td class="text-center"><div class="totalCant_Mbps" style="display: inline-block;"><?php echo e($itemContrato->totalCantMbts); ?></div>&nbsp;Mbps</td>
                                        <td class="text-left">S/.<div class="totalimporte_Mbps" style="display: inline-block;"><?php echo e(round($itemContrato->totalImporMbts,2)); ?></div></td>
                                        <td colspan="2"></td>
                                    </tr>
                                    </tfoot>
                                </table>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <select  id="sel_DispositivoArea" class="selectpicker" data-live-search="true" data-style="btn btn-primary" title="Seleccione" data-size="7" style="top:-7px;">
                                    <?php foreach($data->Dispositivo as $itemDispositivo): ?>
                                        <option value="<?php echo e($itemDispositivo->idDispositivo); ?>"><?php echo e($itemDispositivo->Nombre); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="mdlReporte" data-keyboard="false" data-backdrop="static" style="margin-top: -95px!important;" >
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                        ...
                        <div class="card-jse" style="width: 152px;position: fixed;top: 9px;right: 60px;opacity: 0.9;">
                            <div class="card-body card-padding panel-group">
                                <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <i id="actualizar" style="cursor: pointer; display: block;left: 54px;position: absolute;margin-top: -2px;font-size: 20px;background-color: #c61954;padding: 9px;border-radius: 50%;max-width: 38px;box-shadow: 0 10px 30px -12px rgba(0, 0, 0, 0.42), 0 4px 25px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(0, 0, 0, 0.2)" data-notify="icon" class="btn material-icons md md-polymer">&nbsp;</i>
                                        </div>
                                    </div>
                                </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button id="btn-Generar" type="button" class="btn btn-primary btn-simple" data-dismiss="modal">Generar</button>
                    <button type="button" class="btn btn-danger btn-simple" data-dismiss="modal">Atras</button>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function(){
            ...
            $('#cardSinAsignar').on('click','.btn-edit',function(){
                $('#mdlCrearAreas').find('.modal-title').html('Editar Area');
                    ...
                    type: "POST",
                    //url: '/pagPuntosAccesos/CrearConsumo',
                    url: "<?php echo e(url('/pagPuntosAccesos/obtenerArea')); ?>",
            ...
            $.ajax({
                    type: "POST",
                    url: '<?php echo e(url("/pagPuntosAccesos/EliminarArea")); ?>',
            ...
            $('#lst_Contratos').on('click','.btn-reporte',function(){
                ...
                $('#ifr_reporte').html('');
                var html = '<iframe src="'+'<?php echo e(url("/pagReporte")); ?>/'+mint_idcontrato+'/'+mstr_fechaDesde.split('/').join('-')+'/'+mstr_fechaHasta.split('/').join('-')+'" height="600px" width="100%" frameborder="0" style="border: 0" allowfullscreen></iframe>';
            ...
            function f_generar(vint_idcontrato, vstr_fechaDesde, vstr_fechaHasta){
                $.ajax({
                    type: "POST",
                    url: '<?php echo e(url("/pagPuntosAccesos/GenerarReporte")); ?>',
