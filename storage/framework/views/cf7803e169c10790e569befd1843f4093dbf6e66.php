        ...
        <div class="sidebar-wrapper">
            <ul class="nav">
                ...
                <?php foreach($item as $i): ?>
                    ...
                    <a href="<?php if($i->idArea>0): ?> <?php echo e(url($i->url."?v=".$i->idArea)); ?> <?php else: ?><?php echo e(url($i->url)); ?>  <?php endif; ?>">
                            ...
                            <div class="collapse <?php if($i->resaltado): ?> in <?php endif; ?>" id="<?php echo e($i->id); ?>_AC2">
                                <ul class="nav">
                                    ...
                                    <li <?php if($r->resaltado): ?>class="active"<?php endif; ?>>
                                        <a href="<?php if($i->idArea>0): ?> <?php echo e(url($r->url."?v=".$i->idArea)); ?> <?php else: ?><?php echo e(url($r->url)); ?>  <?php endif; ?>"><?php echo e($r->nombre); ?></a>
                                    </li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
...
<script type="text/javascript" src="../../assets/plugin/highchart/js/highcharts.js"></script>
<script type="text/javascript" src="../../assets/plugin/highchart/js/highcharts-more.js"></script>
<!--<script type="text/javascript" src="../../assets/plugin/highchart/js/themes/gray.js"></script>-->
