...
<button  class="btn bgm-purple btn-float waves-effect waves-button waves-float" id="btnAgregarContrato"><i class="md md-add"></i></button>
<?php $__env->stopSection(); ?>
    ...
    <div class="row" id="cardListcontrato">
        ...
        <div class="col-lg-3 col-sm-4">
            <div class="card card-pricing card-raised">
                <form name="formContrato" class="content" method="POST" role="form" action="<?php echo e(url('/pagContrato/asignarAreaContrato')); ?>">
                    <h6 class="category"><?php echo e($itemContrato->Descripcion); ?></h6>
                    <?php $varr_iconocolor = array("icon-rose","icon-primary","icon-success","icon-info","icon-warning","icon-danger"); ?>
                    <div class="icon <?php echo e($varr_iconocolor[array_rand($varr_iconocolor)]); ?>">
                        <i class="md md-home md-lg"></i>
                    </div>
                    <h6 class="category" style="color: #3c4858;">Asignados</h6>
                    <h3 class="card-title" style="margin-top: 0;"><?php echo e($itemContrato->Velocidad_Mb); ?> <small>Mbts/</small><?php echo e(count($itemContrato->areas)); ?> <small>Areas</small></h3>
                    <p class="card-description">
                        Contrato hecho <?php echo e(Carbon\Carbon::parse($itemContrato->Fech_Emision)->format('d/m/Y')); ?>

                        hasta <?php echo e(Carbon\Carbon::parse($itemContrato->Fech_Vencimiento )->format('d/m/Y')); ?>.
                    </p>
                    <input type="hidden" name="_token" value=""><!-- Esta etique se debe poner en todos los formulario para la validacion -->
                    <input type="hidden" name="_contratoid" value="<?php echo e($itemContrato->idCONTRATO); ?>"><!-- Este valor se de pintar dependiendo de los contratos que tiene el cliente, medinate java scrip o en el servidor -->
                    <button type="submit" class="btn btn-rose btn-round">Areas Asignadas</button>
                </form>
            </div>
            </div>
        <?php endforeach; ?>
                        ...
                        <div class="col-sm-12">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group">
                                    ...
                                    <?php foreach($data->Proveedores as $itemProveedor): ?>
                                        <option value="<?php echo e($itemProveedor->idProveedor); ?>"><?php echo e($itemProveedor->Nom_Empresa); ?></option>
                                    <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
        ...
        $(document).ready(function(){
           ...
           $('#btnCrearDetalle').on('click',function(){
            ...
            $('#btn-Guardar').on('click',function(){
                ...
                $.ajax({
                    type: "POST",
                    url: '<?php echo e(url("/pagContrato/CrearContrato")); ?>',
