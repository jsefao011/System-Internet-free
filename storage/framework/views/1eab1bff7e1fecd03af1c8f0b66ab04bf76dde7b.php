...
<body>
<div>
    <div style="display:inline-block; font-weight: bold; width: 95%"><div style="float: left; display: inline-block;">N° <?php echo e(str_pad($data->contrato->idDocumento, 8,0, STR_PAD_LEFT)); ?></div> <div style="float: right; display: inline-block;"><?php echo e(Carbon\Carbon::parse()->format('d/m/Y')); ?></div></div>
    <div id="logo" style="text-align: center;">
        ...
        <?php else: ?>
            <img style="margin-right: 487px;" src='<?php echo e(url("reporte/consumo/logo-digeti.png")); ?>'>
            <img src='<?php echo e(url("reporte/consumo/logo-upeu.png")); ?>'>
        <?php endif; ?>
    </div>
    ...
    <?php if($data->tipo == 'D'): ?>
        <?php foreach($data->contrato->areas as $i=>$itemArea): ?>
            <div class="subtitulo">
                <div style="width: 95%; display: inline-block">
                    <lu style="list-style-type: none;padding: 0;margin: 0;;">
                        <li style="float: left;width: 5%;display: inline-block;"><a style="display: block;text-decoration: none;text-align: left;"><h2><?php echo e($i+1); ?>.</h2></a></li>
                        <li style="float: left;width: 45%;display: inline-block;;"><a style="display: block;text-decoration: none;text-align: left;"><h3><?php echo e($itemArea->Nom_Area); ?></h3></a></li>
                        <li style="float: left;width: 48%;display: inline-block;;"><a style="display: block;text-decoration: none;text-align: right;"><h3>IMPORTE: S/.<?php echo e(number_format($itemArea->consumo["SubTotal"], 3, '.', ',')); ?></h3></a></li>
                    </lu>
                </div>
            </div>
            ...
            <div class="project" style="display:inline-block; width: 50%;page-break-before: auto;">
                <div><span>PORC. ACUMULADO</span><?php echo e(number_format($itemArea->consumo["Porc_Mbps"], 2, '.', ',')); ?>%</div>
                ...
                <table>
                    ...
                    <?php foreach($itemArea->area as $i1 => $itemArea1): ?>
                        <tr>
                            ...
                            <td style="text-align: center;"><?php echo e(number_format($itemArea1->consumo["Porc_Mbps"], 2, '.', ',')); ?>%</td>
                                    ...
                                    <table style="margin-bottom:0;">
                                        ...
                                        <?php foreach($itemArea1->area as $i2 => $itemArea2): ?>
                                            <tr>
                                                ...
                                                <td style="text-align: center;"><?php echo e(number_format($itemArea2->consumo["Porc_Mbps"], 2, '.', ',')); ?>%</td>
        ...
        <table>
            ...
            <tr>
                ...
                <td style="text-align: center"><?php echo e(number_format($data->contrato->totalPorcMbts, 2, '.', ',')); ?>%</td>
        ...
        <table style="margin-right: 1.5rem">
            ...
            <?php foreach($data->contrato->areas as $i=>$itemArea): ?>
                <tr>
                    ...
                    <td class="unit"><?php echo e(number_format($itemArea->consumo["Porc_Mbps"], 2, '.', ',')); ?></td>
