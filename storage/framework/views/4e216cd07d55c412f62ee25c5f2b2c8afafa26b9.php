    ...
    <div class="row">
        <div class="col-md-12">
            <form class="card modal-content" method="POST" role="form" action="<?php echo e(url('/pagContrato/asignarAreaContrato/Guardar')); ?>">
                <div class="btn card-header card-header-icon" data-background-color="rose" id="btnAsignarArea">
                ...
                <div class="modal-footer" style="padding-top: 0;">
                    ...
                    <a type="button" class="btn btn-danger btn-simple" data-dismiss="modal" href="<?php echo e(url('/pagContrato?v='.$vobj_local->v)); ?>">Atras</a>
                </div>
            </form>
        </div>
    </div>
